...
Revision ID: 5db273b9b2ac
Revises: 
Create Date: 2025-11-22 23:54:36.930278
...
def upgrade() -> None:
    ...
    sa.Column('provider_type', postgresql.ENUM('oauth1', 'oauth2', 'oidc', name='providertype', create_type=False), nullable=False),
    ...
    sa.Column('username_field', sa.String(), nullable=False),
